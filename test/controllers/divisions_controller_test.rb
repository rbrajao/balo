...
class DivisionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create division" do
    assert_difference("Division.count") do
      post divisions_url, params: { division: { godown: @division.godown, goup: @division.goup, name: @division.name, status: @division.status } }
    end
  ...
  test "should update division" do
    patch division_url(@division), params: { division: { godown: @division.godown, goup: @division.goup, name: @division.name, status: @division.status } }
