...
class BetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bet" do
    assert_difference("Bet.count") do
      post bets_url, params: { bet: { score_home: @bet.score_home, score_visit: @bet.score_visit, status: @bet.status, total_point: @bet.total_point } }
    end
  ...
  test "should update bet" do
    patch bet_url(@bet), params: { bet: { score_home: @bet.score_home, score_visit: @bet.score_visit, status: @bet.status, total_point: @bet.total_point } }
